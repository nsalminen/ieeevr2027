...
<ul>
<li><strong class="red">January 6, 2026 (Tuesday)</strong>: Submission of two-page abstract, layout schematic, and video material (1 minute).</li>
<li><strong class="red">January 20, 2026 (Tuesday)</strong>: Notification of results.</li>
<li><strong class="red">January 27, 2026 (Tuesday)</strong>: Submission of camera-ready two-page abstract, final layout, and final video material (1–2 minutes).</li>
</ul>
...
<li> A schematic of the layout (a separate document showing components, such as projectors/cameras): <a href="{{ '/assets/downloads/Template.docx' | relative_url }}" target="_blank">Template.docx</a></li>
